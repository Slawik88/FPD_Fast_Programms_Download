...
def create_browser_window():  
    ...
    browsers_window.geometry(f"{900}x{700}")  # Задание размеров окна
    ...
    browser_scrollable_frame = customtkinter.CTkScrollableFrame(master=browsers_window, width=900, height=1000, label_text="Browser_apps", orientation="vertical")
