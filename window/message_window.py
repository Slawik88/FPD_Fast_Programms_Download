...
def create_message_window():  
    ...
    def checkbox_event(app_id, app_image_path, app_name, app_developer, app_size, app_url_website):
        ...
        cursor.execute(f'''UPDATE messages_app SET app_favorites=? WHERE id=?''', (1 ,app_id))
    ...
    browsers_window.title(f"{app_title} -- Messages")  # Задание заголовка окна
    ...
    message_scrollable_frame = customtkinter.CTkScrollableFrame(master=browsers_window, width=1200, height=1000, label_text="Browser_apps", orientation="vertical")
